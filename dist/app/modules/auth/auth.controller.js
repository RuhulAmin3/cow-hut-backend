...
exports.refreshTokenController = exports.loginUserController = exports.createUserController = void 0;
...
exports.createUserController = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield (0, auth_service_1.createUserService)(req.body);
...
exports.loginUserController = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield (0, auth_service_1.loginUserService)(loginData);
    const cookieOption = {
