...
const updateCowService = (id, data, user) => __awaiter(void 0, void 0, void 0, function* () {
    const cow = yield cow_model_1.Cow.findOne({ _id: id, seller: user.id });
    if (!cow) {
        throw new ApiError_1.ApiError(http_status_1.default.NOT_FOUND, "this is not your cow. you can only update your cow");
    }
    const result = yield cow_model_1.Cow.findOneAndUpdate({ _id: id, seller: user.id }, data, { new: true });
    return result;
});
...
const deleteCowService = (id, user) => __awaiter(void 0, void 0, void 0, function* () {
    const cow = yield cow_model_1.Cow.findOne({ _id: id, seller: user.id });
    if (!cow) {
        throw new ApiError_1.ApiError(http_status_1.default.NOT_FOUND, "this is not your cow. you can only delete your cow");
    }
    const result = yield cow_model_1.Cow.findOneAndUpdate({ _id: id, seller: user.id });
    return result;
});
